const Footer = () => {
  return (
    <div>
      <div
        className="h-[40rem] text-center mt-56 bg-cover bg-center flex flex-col w-full justify-between image-rendering"
        style={{
      ...
      >
        <div className="w-full pt-8 px-4">
          ...
          <p className="text-3xl mt-2">Rates Protocol is on-chain game build on EVM</p>
          <div className="mt-8">
      ...
      {/* mobile nav padding */}
      <div className="lg:hidden h-[84px]"></div>
    </div>
  )
}
